                  ...
                  FormBuilder(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        FormBuilderTextField(
                          ...
                          decoration: InputDecoration(
                            labelText: "আত্মীয়ের/আপনার ফোন নম্বর (১১ ডিজিট)",
                            filled: true,
                            fillColor: Colors.grey[200],
                          ),
                        ...
                        FormBuilderTextField(
                          attribute: "number",
                          decoration: InputDecoration(
                            labelText: "আত্মীয়ের এন আই ডি (অপশনাল)",
                            filled: true,
                            fillColor: Colors.grey[200],
                          ),
                          keyboardType: TextInputType.number,
                    ...
                    onSaved: (value) => passportID = value,
                        ...
                        Padding(
                          padding: const EdgeInsets.only(left: 10, top: 10),
                          child: AutoSizeText(
                              "ওনার কি জ্বর আছে বা জ্বরজ্বর অনুভব করছেন?"),
                        ),
                        FormBuilderChoiceChip(
                          attribute: 'choice_chip',
                          decoration: InputDecoration(
                        ...
                        Padding(
                          padding: const EdgeInsets.only(left: 10, top: 10),
                          child: AutoSizeText(
                              "ওনার কি কাশি বা গলাব্যথা বা দুইটাই আছে?"),
                        ),
                        FormBuilderChoiceChip(
                          attribute: 'choice_chip',
                          decoration: InputDecoration(
                        ...
                        Padding(
                          padding: const EdgeInsets.only(left: 10, top: 10),
                          child: AutoSizeText(
                              "ওনার কি শ্বাসকষ্ট আছে বা শ্বাস নিতে বা ফেলতে কষ্ট হচ্ছে?"),
                        ),
                        FormBuilderChoiceChip(
                          attribute: 'choice_chip',
                          decoration: InputDecoration(
                        ...
                        Padding(
                          padding: const EdgeInsets.only(left: 10, top: 10),
                          child: AutoSizeText(
                              "তিনি কি বিগত ১৪ দিনের ভিতরে বিদেশ হতে এসেছেন?"),
                        ),
                        FormBuilderChoiceChip(
                          attribute: 'choice_chip',
                          decoration: InputDecoration(
                        ...
                        Padding(
                          ...
                          child: AutoSizeText(
                              "তিনি কি বিগত ১৪ দিনের ভিতরে করোনা ভাইরাসে ( কোভিড -১৯) আক্রান্ত এরকম কোন ব্যক্তির সংস্পর্শে এসেছিলেন ( একই স্থানে অবস্থান বা ভ্রমন )?"),
                        ),
                        FormBuilderChoiceChip(
                          attribute: 'choice_chip',
                          decoration: InputDecoration(
                        ...
                        Padding(
                          padding: const EdgeInsets.only(left: 10.0, top: 10),
                          child: AutoSizeText(
                              "বিগত ১৪ দিনে জর, কাশি, শ্বাসকষ্ট আছে এমন কারোর সংস্পর্শে কি তিনি এসেছিলেন ( পরিবার সদস্য / অফিস কলিগ ) ?"),
                        ),
                        FormBuilderChoiceChip(
                          attribute: 'choice_chip',
                          decoration: InputDecoration(
                        ...
                        Padding(
                          padding: const EdgeInsets.only(left: 10.0, top: 10),
                          child: AutoSizeText(
                              "তিনি কি অন্য কোন অসুখে  ভুগছেন (যেমন : ডায়াবেটিস, এজমা বা হাঁপানি , দীর্ঘমেয়াদি শ্বাসকষ্টের রোগ বা সিওপিডি, কিডনি রোগ, ক্যান্সার বা ক্যান্সারের জন্য কোন চিকিৎসা নিচ্ছেন?"),
                        ),
                        FormBuilderChoiceChip(
                          attribute: 'choice_chip',
                          decoration: InputDecoration(
