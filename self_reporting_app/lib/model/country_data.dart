...
//    চট্টগ্রাম বিভাগ
      ...
      case 'নোয়াখালি':
        upazilaList = ['নোয়াখালি', 'কোম্পানীগঞ্জ', 'বেগমগঞ্জ', 'হাতিয়া', 'সুবর্ণচর', 'কবিরহাট', 'সেনবাগ',
          'চাটখিল', 'সোনাইমুড়ী'];
        break;
...
//    রাজশাহী বিভাগ
      ...
      case 'বগুড়া':
        upazilaList = ['কাহালু উপজেলা', ' বগুড়া সদর', ' সারিয়াকান্দি', ' শাজাহানপুর', ' দুপচাচিঁয়া উপজেলা',
...
//    ময়মনসিংহ বিভাগ
      ...
      case 'ময়মনসিংহ':
        upazilaList = ['ফুলবাড়ীয়া', 'ত্রিশাল', 'ভালুকা', 'মুক্তাগাছা', 'ময়মনসিংহ সদর', 'ধোবাউড়া',
...
//  all district list
  ...
  List<String> getBarisalDistrictListBn(){
    List<String> districtList = ['বরিশাল', 'ভোলা', 'বরগুনা', 'পিরোজপুর', 'পটুয়াখালী', 'ঝালকাঠি'];
    return districtList;
  }

  List<String> getChattogramDistrictListBn(){
    List<String> districtList = ['লক্ষ্মীপুর', 'রাঙ্গামাটি', 'ব্রাহ্মণবাড়িয়া', 'বান্দরবান', 'ফেনী',
      'নোয়াখালি', 'চাঁদপুর', 'চট্টগ্রাম', 'খাগড়াছড়ি', 'কুমিল্লা', 'কক্সবাজার'];
    return districtList;
  }
